                ...
                <tr v-for="(siswas, i) in pageOfItems" :key="siswas.id_siswa">
                  ...
                  <td style="text-align:center;">
                    <a
                      ...
                      @click="
                        (detailModal = true),
                          getData(siswas.id_siswa, (kelas = 0)),
                          getKelas()
                      "
                    ...
                    <a
                      ...
                      @click="
                        (editModal = true),
                          getData(siswas.id_siswa, (kelas = null)),
                          getKelas()
                      "
              ...
              <div class="modal-content">
                ...
                >
                  ...
                  <button
                    ...
                    class="btn btn-danger"
                    data-dismiss="modal"
                    @click="(deleteModal = false), hapus(dels.id_siswa, slice)"
                  >
                    Hapus
                  </button>
                </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            ...
                            >
                              <p
                                v-if="forms.kelas === kelass.id_kelas"
                                style="text-transform: uppercase;"
                                class="form-control"
                              >
                                {{ kelass.kelas }} {{ kelass.jurusan }}
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <form>
                  ...
                  <div class="modal-footer">
                    ...
                    <button
                      ...
                      class="btn btn-primary"
                      data-dismiss="modal"
                      @click="(editModal = false), editData()"
                    >
                      Submit
                    </button>
                  </div>
...
export default {
  ...
  methods: {
    ...
    showAll() {
      axios.get("http://localhost/api/siswa").then((response) => {
